...
$.fn.uploadAdapter = function(opts){
	...
	defaults.swf = defaults.baseUrl+'/uploadify.swf';
	...
	var setLoaderValue = function(type){
		if(type=='html5'){
			...
			jsUrl = option.baseUrl+'/jquery.Huploadify.js';
			cssUrl = option.baseUrl+'/Huploadify.css';
		}
		else{
			pluginName = 'uploadify';
			jsUrl = option.baseUrl+'/jquery.uploadify.min.js';
			cssUrl = option.baseUrl+'/Huploadify.css';
		}
	}
