...
BeatPicker.prototype={dateInputNode:null,pickerNode:null,daysSimple:"Su Mo Tu We Th Fr Sa".split(" "),daysFull:[],monthsSimple:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),monthsFull:"January February March April May June July August September October November December".split(" "),startDate:new Date,currentDate:new Date,dateFormat:{separator:"-",format:["YYYY","MM","DD"]},modules:{heade:!0,footer:!0,daysOfTheWeek:!0,navBar:!0,today:!0,gotoDate:!0,icon:!0,clear:!0},selectionRule:{single:!0,
range:!1,rangeDisableSelect:!1},className:{beatPicker:"beatpicker",heade:"heade",footer:"footer",days:"days",inputParent:"input-parent",headeNavBarParent:"heade-navbar-container",headeNavBarButton:"heade-navbar-button",weekDaysAliasCell:"week-alias-cell",weekDaysAliasCellParent:"week-alias-cell-parent",input:"beatpicker-input",inputTo:"beatpicker-input-to",betweenRange:"between-range",inputFrom:"beatpicker-input-from",daysCell:"days-cell",monthsCell:"months-cell",yearsCell:"years-cell",yearsRangeCell:"years-range-cell",
daysCellParent:"days-cell-parent",todayButton:"today",todayBox:"today-box",gotoDateParent:"goto-date-parent",gotoDateInput:"goto-date",gotoDateButton:"goto-date-button",selected:"selected",disabled:"disabled",clear:"beatpicker-clear",_inner:{beatPicker:"beatpicker",inputContainer:"input-container",cell:"cell",cellM:"cell-months",cellY:"cell-years",cellYR:"cell-years-range",cellParent:"cell-parent",headeNavBar:"main-nav",headeNavBarBtn:"nav-btn",headeNavBarBtnNext:"next",headeNavBarBtnPrev:"prev",
inputNode:"beatpicker-inputnode",dateInputTo:"beatpicker-inputnode-to",betweenDateNode:"between-range",dateInputFrom:"beatpicker-inputnode-from",headeNavBarBtnMonthIndicator:"current-indicator",notNotable:"not-notable",todayButton:"today",gotoDateInput:"date-input",gotoDateButton:"date-input-button",gotoDateContainer:"goto-date-container",footer:"footer",todayInGrid:"notable-today",selectedDate:"selected-date",disableDate:"date-disabled",clearButton:"beatpicker-clearButton",defaultButton:"button"}},
...
a.cq(a.events.clear,b);a.reset()}});this.a.append(b)},af:function(){this.dateInputNode.add(this.b).css("background-image","url('"+this.view.iconImage+"')")},ag:function(a){var b=this;a=this.bw("div",{"class":this.bx(this.className.headeNavBarParent,this.className._inner.headeNavBar)},a,"",!0);this.bw("a",{"class":this.bx(this.className.headeNavBarButton,this.className._inner.headeNavBarBtn,this.className._inner.headeNavBarBtnNext,this.className._inner.defaultButton)},a,">").on("click",function(){b.cb(!1)});
var c=this._currentIndicator=this.bw("a",{"class":this.bx(this.className.headeNavBarButton,this.className._inner.headeNavBarBtn,this.className._inner.headeNavBarBtnMonthIndicator,this.className._inner.defaultButton)},a).on("click",function(){b.cf(!0)});this.av(c,this.y.briefDate);this.bw("a",{"class":this.bx(this.className.headeNavBarButton,this.className._inner.headeNavBarBtn,this.className._inner.headeNavBarBtnPrev,this.className._inner.defaultButton)},a,"<").on("click",function(a){b.cb(!0)})},
ah:function(){var a=this.bw("div",{"class":this.className.heade});this.modules.daysOfTheWeek&&a.append(this.ai(this.daysSimple));return a},ai:function(a){if(a instanceof Array){var b=this._weekDayParent=this.bw("ul",{"class":this.className.weekDaysAliasCellParent+" "+this.className._inner.cellParent});this.forEach(a,function(a,d){this.bw("li",{"class":this.className.weekDaysAliasCell+" "+this.className._inner.cell},b,d)},this);return b}},aj:function(){return this._footerNode=this.bw("div",{"class":this.bx(this.className.footer,
